...
const LogForm = ({ setFormValues }: Props) => {
	const validationSchema = Yup.object({
		...
		exercises: Yup.array().of(
			Yup.object({
				name: Yup.string().required("exercise_name_is_required"),
				weightMetric: Yup.string().required("weight_metric_is_required"),
				sets: Yup.number().required("number_of_sets_is_required"),
				setDetails: Yup.array().of(
					Yup.object({
						setNumber: Yup.number().required("set_number_is_required"),
						weight: Yup.number()
							.required("weight_is_required")
							.min(1, "weight_must_be_positive"),
						reps: Yup.number()
							.required("reps_are_required")
							.min(1, "reps_must_be_positive"),
					})
				),
			})
		),
											...
											return (
												...
												>
													...
													<div className='flex mr-4'>
														...
														>
															<SelectTrigger className='w-[100px]'>
																<SelectValue placeholder='select_weight_metric' />
															</SelectTrigger>
															<SelectContent>
