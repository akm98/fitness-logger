...
export const exercisesOptions = [
  ...
  { label: "Bench Press", value: "Bench Press", bodyPart: "Chest Shoulders Triceps" },
  { label: "Overhead Press", value: "Overhead Press", bodyPart: "Chest Shoulders Triceps" },
  { label: "Tricep Dips", value: "Tricep Dips", bodyPart: "Chest Shoulders Triceps" },
  ...
  { label: "Chest Fly", value: "Chest Fly", bodyPart: "Chest Shoulders Triceps" },
  { label: "Shoulder Press", value: "Shoulder Press", bodyPart: "Chest Shoulders Triceps" },
  { label: "Cable Tricep Extensions", value: "Cable Tricep Extensions", bodyPart: "Chest Shoulders Triceps" },
  ...
  { label: "Kettlebell Swings", value: "Kettlebell Swings", bodyPart: "Full Body" },
  { label: "Battle Ropes", value: "Battle Ropes", bodyPart: "Full Body" },
  { label: "Rowing Machine", value: "Rowing Machine", bodyPart: "Full Body" },
  { label: "Treadmill Sprints", value: "Treadmill Sprints", bodyPart: "Full Body" },
